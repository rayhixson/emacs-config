...

;;;### (autoloads nil "multi-eshell" "multi-eshell.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "multi-eshell" '("shell-with-name" "multi-eshell-" "if-void")))
